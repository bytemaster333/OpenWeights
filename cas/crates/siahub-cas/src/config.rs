...
pub struct Config {
    ...
    /// HS256 signing secret for SiaHub-issued Xet JWTs (migration 0008).
    ...
    /// Empty default means "SiaHub HF-compat mode disabled" — the
    /// /api/* handlers return 503 until the operator sets this.
    #[serde(default)]
    pub xet_jwt_signing_key: String,

    /// URL clients reach SiaHub CAS at for Xet uploads/downloads. This is
...
fn default_cas_public_url() -> String {
    ...
    // (127.0.0.1:28080 -> siahub-cas:8080).
