...
//! Backs. Requires a valid `openweights_session` cookie (extractor
...
//! Response: `204 No Content` with `Set-Cookie: openweights_session=; Max-Age=0`.
...
mod tests {
    ...
    #[test]
    fn clear_cookie_header_mentions_openweights_session() {
