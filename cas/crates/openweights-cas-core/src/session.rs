...
pub const SESSION_COOKIE_NAME: &str = "openweights_session";
...
/// Extract `openweights_session=<uuid>` from a raw `Cookie:` header value. Tolerant
...
mod tests {
    ...
    #[test]
    fn session_cookie_name_locked_to_openweights_session() {
        //name is part of the cross-service contract; breaking it
        // silently logs every user out.
        assert_eq!(SESSION_COOKIE_NAME, "openweights_session");
    }
}
