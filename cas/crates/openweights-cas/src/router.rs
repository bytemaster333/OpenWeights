...
use openweights_cas_core::handlers;
...
pub fn build(state: AppState) -> Router {
    ...
    Router::new()
        ...
        .route(
            "/metrics",
            get(openweights_cas_core::metrics::metrics_handler::<AppState>),
        )
        ...
        // Owned by per ; consumed by openweights-console's
        ...
        // `hf download` target OpenWeights as the Hub itself, not
