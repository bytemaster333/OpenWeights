...
//! drifts by at most 1.
//! ## No cycle with openweights-cas-core
//! This module defines the [`ReconcilerMetrics`] trait locally and takes it
//! as a generic. `openweights-cas-core`'s `Metrics` struct implements this trait.
...
/// Implemented by `openweights_cas_core::metrics::Metrics` — the two crates meet
