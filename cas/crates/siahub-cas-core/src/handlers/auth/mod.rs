...
//!
//! Plan 04-01 (Phase 2.1 amendment — D-41, D-44, D-50). Surface:
//!
//! | Method + Path              | Handler                       |
//! |----------------------------|-------------------------------|
...
//! `users` row keyed on numeric `users.id BIGINT` (NOT email — P13), mints a
//! session row + `siahub_session` cookie, and redirects the browser back to
//! the console.
//!
//! P14 mitigation: structured error codes `oauth_state_mismatch`,
