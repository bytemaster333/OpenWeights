...
// (D-30 / GATE-09) — NOT on hash+range. Range is a view over the whole-xorb
...
// for downstream plans. Plan 03-05 wraps a singleflight.Group in a small
...
// increments, which is what the GATE-09 "≥99-out-of-100 coalesced"
